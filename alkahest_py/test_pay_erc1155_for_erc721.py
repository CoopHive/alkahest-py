...
async def test_pay_erc1155_for_erc721():
    ...
    env.bob_client.erc721.approve(bid_data, "escrow")
    
    buy_result = env.bob_client.erc721.buy_erc1155_with_erc721(bid_data, ask_data, 0)
    buy_attestation_uid = buy_result['log']['uid']
    
    # Alice approves her ERC1155 tokens for payment
    env.alice_client.erc1155.approve_all(env.mock_addresses.erc1155_a, "payment")
    ...
    pay_result = env.alice_client.erc1155.pay_erc1155_for_erc721(buy_attestation_uid)
