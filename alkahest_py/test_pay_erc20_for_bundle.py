import pytest
from alkahest_py import EnvTestManager, MockERC20, MockERC721, MockERC1155, ERC20PaymentObligationStatement
...
async def test_pay_erc20_for_bundle():
    ...
    payment_statement = ERC20PaymentObligationStatement(
