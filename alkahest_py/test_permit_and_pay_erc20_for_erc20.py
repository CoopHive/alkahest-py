...
async def test_permit_and_pay_erc20_for_erc20():
    try:
        ...
        if bob_allowance != 0:
            raise Exception(f"Bob should have no allowance before permit, got {bob_allowance}")
        ...
        print("✅ test_permit_and_pay_erc20_for_erc20 PASSED")
        return True
...
async def main():
    success = await test_permit_and_pay_erc20_for_erc20()
