...
async def test_permit_and_pay_erc20_for_erc1155():
    ...
    try:
        ...
        if bob_balance != token_amount:
            raise Exception(f"Token balance verification failed. Expected {token_amount}, got {bob_balance}")
        ...
        print("✅ test_permit_and_pay_erc20_for_erc1155 PASSED")
        return True
        
    except Exception as e:
        print(f"❌ test_permit_and_pay_erc20_for_erc1155 FAILED: {e}")
        raise


if __name__ == "__main__":
    asyncio.run(test_permit_and_pay_erc20_for_erc1155())
