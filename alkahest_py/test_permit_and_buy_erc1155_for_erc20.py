...
async def test_permit_and_buy_erc1155_for_erc20():
    ...
    try:
        ...
        print("✅ test_permit_and_buy_erc1155_for_erc20 PASSED")
        
    except Exception as e:
        print(f"❌ test_permit_and_buy_erc1155_for_erc20 FAILED: {e}")
        raise


if __name__ == "__main__":
    asyncio.run(test_permit_and_buy_erc1155_for_erc20())
