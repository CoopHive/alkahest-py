...
async def test_permit_and_pay_erc20_for_erc721():
    ...
    try:
        ...
        pay_result = await env.alice_client.erc20.permit_and_pay_erc20_for_erc721(buy_attestation_uid)
        ...
        print("✅ test_permit_and_pay_erc20_for_erc721 PASSED")
        return True
        
    except Exception as e:
        print(f"❌ test_permit_and_pay_erc20_for_erc721 FAILED: {e}")
        raise


if __name__ == "__main__":
    asyncio.run(test_permit_and_pay_erc20_for_erc721())
