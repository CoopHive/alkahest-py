...
async def test_permit_and_pay_erc20_for_erc721():
    ...
    env.bob_client.erc721.approve(erc721_data, "escrow")
    
    # Step 2: Bob creates ERC721 escrow requesting ERC20
    erc20_data = {"address": env.mock_addresses.erc20_a, "value": erc20_amount}
    buy_result = env.bob_client.erc721.buy_erc20_with_erc721(erc721_data, erc20_data, expiration)
    ...
    pay_result = env.alice_client.erc20.permit_and_pay_erc20_for_erc721(buy_attestation_uid)
