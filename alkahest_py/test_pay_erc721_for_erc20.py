import asyncio
from alkahest_py import PyTestEnvManager, PyMockERC721, PyMockERC20
...
async def test_pay_erc721_for_erc20():
    ...
    try:
        ...
        if bob_after_transfer != bob_initial_erc20 + 100:
            raise Exception(f"Bob ERC20 transfer failed. Expected {bob_initial_erc20 + 100}, got {bob_after_transfer}")
        ...
        if alice_erc20_balance != 100:
            raise Exception(f"Alice should have received 100 ERC20 tokens, got {alice_erc20_balance}")
        ...
        print("✅ test_pay_erc721_for_erc20 PASSED")
        return True
        
    except Exception as e:
        print(f"❌ test_pay_erc721_for_erc20 FAILED: {e}")
        raise


if __name__ == "__main__":
    asyncio.run(test_pay_erc721_for_erc20())
