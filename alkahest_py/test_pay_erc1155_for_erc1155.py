...
async def test_pay_erc1155_for_erc1155():
    ...
    env.alice_client.erc1155.approve_all(env.mock_addresses.erc1155_a, "escrow")
    
    buy_result = env.alice_client.erc1155.buy_erc1155_for_erc1155(bid_data, ask_data, 0)
    buy_attestation_uid = buy_result['log']['uid']
    
    # Bob approves tokens for payment
    env.bob_client.erc1155.approve_all(env.mock_addresses.erc1155_b, "payment")
    ...
    pay_result = env.bob_client.erc1155.pay_erc1155_for_erc1155(buy_attestation_uid)
