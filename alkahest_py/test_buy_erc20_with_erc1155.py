...
async def test_buy_erc20_with_erc1155():
    ...
    try:
        ...
        buy_result = await env.alice_client.erc1155.buy_erc20_with_erc1155(bid_data, ask_data, 0)
        ...
        print("✅ ERC1155 to ERC20 purchase offer created")
        print(f"ERC1155 tokens in escrow: {escrow_balance}")
        print(f"Alice remaining balance: {alice_balance_after}")
        
        print("✅ test_buy_erc20_with_erc1155 PASSED")
        return True
        
    except Exception as e:
        print(f"❌ test_buy_erc20_with_erc1155 FAILED: {e}")
        raise


async def main():
    try:
        success = await test_buy_erc20_with_erc1155()
