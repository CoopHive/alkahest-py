...
async def test_pay_erc1155_for_erc20():
    ...
    try:
        ...
        if bob_erc20_balance != 100:
            raise Exception(f"Bob should have 100 ERC20 tokens, got {bob_erc20_balance}")
        ...
        if alice_received_erc20 != 100:
            raise Exception(f"Alice should have received 100 ERC20 tokens, got {alice_received_erc20}")
        ...
        print("✅ test_pay_erc1155_for_erc20 PASSED")
        return True
        
    except Exception as e:
        print(f"❌ test_pay_erc1155_for_erc20 FAILED: {e}")
        raise


async def main():
    try:
        success = await test_pay_erc1155_for_erc20()
