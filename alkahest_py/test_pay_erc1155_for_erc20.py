...
async def test_pay_erc1155_for_erc20():
    ...
    env.bob_client.erc20.approve(bid_data, "escrow")
    
    buy_result = env.bob_client.erc20.buy_erc1155_for_erc20(bid_data, ask_data, 0)
    ...
    pay_result = env.alice_client.erc1155.pay_erc1155_for_erc20(buy_attestation_uid)
